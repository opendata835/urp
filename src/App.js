...
import { RolesList, RolesShow, RolesCreate, RolesEdit } from './configuration/taxonomy/roles'
import { UsersList, UsersShow, UsersCreate, UsersEdit } from './configuration/taxonomy/users'
...
const App = () => (
    <div>    
        ...
        >
            ...
            <Resource name="roles" list={RolesList} show={RolesShow} create={RolesCreate} edit={RolesEdit} />
